...
FILE_HEAD = '/home/stephen/Desktop/Documents/Personal/jsgame/bindings/OpenAL/al.h'
FILE_JSON = '/home/stephen/Desktop/Documents/Personal/jsgame/bindings/OpenAL/bind.json'

#constant and function patterns
constant_pattern = """
    .+define[\s]+       #define C/C++ keyword
    
    (?P<name>AL_[^\s]+) #Constant name
...
function_pattern = """
    [\s]*AL_API[\s]+          #extern declaration
    
    (?P<return_type>[^\s]+)  #Function return type
    
    [\s]*AL_APIENTRY[\s]+
    
    (?P<name>al[A-Za-z0-9]+) #Function name
