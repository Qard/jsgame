...
void funcSpaceballMotionFunc(int arg0, int arg1, int arg2) {
	...
	TryCatch try_catch;
	Handle<Value> result = persistentSpaceballMotionFunc->Call(
		GlutFactory::glut_persistent_context->Global(), 3, valueArr);
...
void funcSpaceballRotateFunc(int arg0, int arg1, int arg2) {
	...
	TryCatch try_catch;
	Handle<Value> result = persistentSpaceballRotateFunc->Call(
		GlutFactory::glut_persistent_context->Global(), 3, valueArr);
...
void funcSpaceballButtonFunc(int arg0, int arg1) {
	...
	TryCatch try_catch;
	Handle<Value> result = persistentSpaceballButtonFunc->Call(
		GlutFactory::glut_persistent_context->Global(), 2, valueArr);
...
void funcButtonBoxFunc(int arg0, int arg1) {
	...
	TryCatch try_catch;
	Handle<Value> result = persistentButtonBoxFunc->Call(
		GlutFactory::glut_persistent_context->Global(), 2, valueArr);
...
void funcDialsFunc(int arg0, int arg1) {
	...
	TryCatch try_catch;
	Handle<Value> result = persistentDialsFunc->Call(
		GlutFactory::glut_persistent_context->Global(), 2, valueArr);
...
void funcTabletMotionFunc(int arg0, int arg1) {
	...
	TryCatch try_catch;
	Handle<Value> result = persistentTabletMotionFunc->Call(
		GlutFactory::glut_persistent_context->Global(), 2, valueArr);
...
void funcTabletButtonFunc(int arg0, int arg1, int arg2, int arg3) {
	...
	TryCatch try_catch;
	Handle<Value> result = persistentTabletButtonFunc->Call(
		GlutFactory::glut_persistent_context->Global(), 4, valueArr);
...
void funcMenuStatusFunc(int arg0, int arg1, int arg2) {
	...
	TryCatch try_catch;
	Handle<Value> result = persistentMenuStatusFunc->Call(
		GlutFactory::glut_persistent_context->Global(), 3, valueArr);
...
void funcOverlayDisplayFunc() {
	...
	TryCatch try_catch;
	Handle<Value> result = persistentOverlayDisplayFunc->Call(
		GlutFactory::glut_persistent_context->Global(), 0, valueArr);
...
void funcWindowStatusFunc(int arg0) {
	...
	TryCatch try_catch;
	Handle<Value> result = persistentWindowStatusFunc->Call(
		GlutFactory::glut_persistent_context->Global(), 1, valueArr);
...
void funcKeyboardUpFunc(unsigned char arg0, int arg1, int arg2) {
	...
	TryCatch try_catch;
	Handle<Value> result = persistentKeyboardUpFunc->Call(
		GlutFactory::glut_persistent_context->Global(), 3, valueArr);
...
void funcSpecialUpFunc(int arg0, int arg1, int arg2) {
	...
	TryCatch try_catch;
	Handle<Value> result = persistentSpecialUpFunc->Call(
		GlutFactory::glut_persistent_context->Global(), 3, valueArr);
