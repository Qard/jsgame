...
Handle<Value> GLULookAtCallback(const Arguments& args) {
	...
	//make call
	gluLookAt((GLdouble) arg0, (GLdouble) arg1, (GLdouble) arg2,
		(GLdouble) arg3, (GLdouble) arg4, (GLdouble) arg5,
		(GLdouble) arg6, (GLdouble) arg7, (GLdouble) arg8);
...
Handle<Value> GLUOrtho2DCallback(const Arguments& args) {
	...
	//make call
	gluOrtho2D((GLdouble) arg0, (GLdouble) arg1,
...
Handle<Value> GLUPerspectiveCallback(const Arguments& args) {
	...
	//make call
	gluPerspective((GLdouble) arg0, (GLdouble) arg1,
		(GLdouble) arg2, (GLdouble) arg3);
...
Handle<Value> GLUPickMatrixCallback(const Arguments& args) {
	...
	//make call
	gluPickMatrix((GLdouble) arg0, (GLdouble) arg1, (GLdouble) arg2,
		(GLdouble) arg3, (GLint*) arg4);
...
Handle<ObjectTemplate> createGlu(void) {
	...
	Glu->SetAccessor(String::NewSymbol("EXT_object_space_tess"), GetGLU_EXT_object_space_tess);
	Glu->SetAccessor(String::NewSymbol("EXT_nurbs_tessellator"), GetGLU_EXT_nurbs_tessellator);
	
	Glu->SetAccessor(String::NewSymbol("FALSE"), GetGLU_FALSE);
	Glu->SetAccessor(String::NewSymbol("TRUE"), GetGLU_TRUE);
	
	Glu->SetAccessor(String::NewSymbol("VERSION_1_1"), GetGLU_VERSION_1_1);
	Glu->SetAccessor(String::NewSymbol("VERSION_1_2"), GetGLU_VERSION_1_2);
	Glu->SetAccessor(String::NewSymbol("VERSION_1_3"), GetGLU_VERSION_1_3);
	Glu->SetAccessor(String::NewSymbol("VERSION"), GetGLU_VERSION);
	Glu->SetAccessor(String::NewSymbol("EXTENSIONS"), GetGLU_EXTENSIONS);
	
	Glu->SetAccessor(String::NewSymbol("INVALID_ENUM"), GetGLU_INVALID_ENUM);
	Glu->SetAccessor(String::NewSymbol("INVALID_VALUE"), GetGLU_INVALID_VALUE);
	Glu->SetAccessor(String::NewSymbol("OUT_OF_MEMORY"), GetGLU_OUT_OF_MEMORY);
	Glu->SetAccessor(String::NewSymbol("INCOMPATIBLE_GL_VERSION"), GetGLU_INCOMPATIBLE_GL_VERSION);
	Glu->SetAccessor(String::NewSymbol("INVALID_OPERATION"), GetGLU_INVALID_OPERATION);
	
	Glu->SetAccessor(String::NewSymbol("OUTLINE_POLYGON"), GetGLU_OUTLINE_POLYGON);
	Glu->SetAccessor(String::NewSymbol("OUTLINE_PATCH"), GetGLU_OUTLINE_PATCH);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR"), GetGLU_NURBS_ERROR);
	Glu->SetAccessor(String::NewSymbol("ERROR"), GetGLU_ERROR);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_BEGIN"), GetGLU_NURBS_BEGIN);
	Glu->SetAccessor(String::NewSymbol("NURBS_BEGIN_EXT"), GetGLU_NURBS_BEGIN_EXT);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_VERTEX"), GetGLU_NURBS_VERTEX);
	Glu->SetAccessor(String::NewSymbol("NURBS_VERTEX_EXT"), GetGLU_NURBS_VERTEX_EXT);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_NORMAL"), GetGLU_NURBS_NORMAL);
	Glu->SetAccessor(String::NewSymbol("NURBS_NORMAL_EXT"), GetGLU_NURBS_NORMAL_EXT);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_COLOR"), GetGLU_NURBS_COLOR);
	Glu->SetAccessor(String::NewSymbol("NURBS_COLOR_EXT"), GetGLU_NURBS_COLOR_EXT);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_TEXTURE_COORD"), GetGLU_NURBS_TEXTURE_COORD);
	Glu->SetAccessor(String::NewSymbol("NURBS_TEX_COORD_EXT"), GetGLU_NURBS_TEX_COORD_EXT);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_END"), GetGLU_NURBS_END);
	Glu->SetAccessor(String::NewSymbol("NURBS_END_EXT"), GetGLU_NURBS_END_EXT);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_BEGIN_DATA"), GetGLU_NURBS_BEGIN_DATA);
	Glu->SetAccessor(String::NewSymbol("NURBS_BEGIN_DATA_EXT"), GetGLU_NURBS_BEGIN_DATA_EXT);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_VERTEX_DATA"), GetGLU_NURBS_VERTEX_DATA);
	Glu->SetAccessor(String::NewSymbol("NURBS_VERTEX_DATA_EXT"), GetGLU_NURBS_VERTEX_DATA_EXT);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_NORMAL_DATA"), GetGLU_NURBS_NORMAL_DATA);
	Glu->SetAccessor(String::NewSymbol("NURBS_NORMAL_DATA_EXT"), GetGLU_NURBS_NORMAL_DATA_EXT);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_COLOR_DATA"), GetGLU_NURBS_COLOR_DATA);
	Glu->SetAccessor(String::NewSymbol("NURBS_COLOR_DATA_EXT"), GetGLU_NURBS_COLOR_DATA_EXT);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_TEXTURE_COORD_DATA"), GetGLU_NURBS_TEXTURE_COORD_DATA);
	Glu->SetAccessor(String::NewSymbol("NURBS_TEX_COORD_DATA_EXT"), GetGLU_NURBS_TEX_COORD_DATA_EXT);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_END_DATA"), GetGLU_NURBS_END_DATA);
	Glu->SetAccessor(String::NewSymbol("NURBS_END_DATA_EXT"), GetGLU_NURBS_END_DATA_EXT);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR1"), GetGLU_NURBS_ERROR1);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR2"), GetGLU_NURBS_ERROR2);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR3"), GetGLU_NURBS_ERROR3);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR4"), GetGLU_NURBS_ERROR4);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR5"), GetGLU_NURBS_ERROR5);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR6"), GetGLU_NURBS_ERROR6);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR7"), GetGLU_NURBS_ERROR7);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR8"), GetGLU_NURBS_ERROR8);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR9"), GetGLU_NURBS_ERROR9);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR10"), GetGLU_NURBS_ERROR10);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR11"), GetGLU_NURBS_ERROR11);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR12"), GetGLU_NURBS_ERROR12);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR13"), GetGLU_NURBS_ERROR13);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR14"), GetGLU_NURBS_ERROR14);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR15"), GetGLU_NURBS_ERROR15);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR16"), GetGLU_NURBS_ERROR16);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR17"), GetGLU_NURBS_ERROR17);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR18"), GetGLU_NURBS_ERROR18);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR19"), GetGLU_NURBS_ERROR19);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR20"), GetGLU_NURBS_ERROR20);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR21"), GetGLU_NURBS_ERROR21);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR22"), GetGLU_NURBS_ERROR22);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR23"), GetGLU_NURBS_ERROR23);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR24"), GetGLU_NURBS_ERROR24);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR25"), GetGLU_NURBS_ERROR25);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR26"), GetGLU_NURBS_ERROR26);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR27"), GetGLU_NURBS_ERROR27);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR28"), GetGLU_NURBS_ERROR28);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR29"), GetGLU_NURBS_ERROR29);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR30"), GetGLU_NURBS_ERROR30);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR31"), GetGLU_NURBS_ERROR31);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR32"), GetGLU_NURBS_ERROR32);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR33"), GetGLU_NURBS_ERROR33);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR34"), GetGLU_NURBS_ERROR34);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR35"), GetGLU_NURBS_ERROR35);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR36"), GetGLU_NURBS_ERROR36);
	Glu->SetAccessor(String::NewSymbol("NURBS_ERROR37"), GetGLU_NURBS_ERROR37);
	
	Glu->SetAccessor(String::NewSymbol("AUTO_LOAD_MATRIX"), GetGLU_AUTO_LOAD_MATRIX);
	Glu->SetAccessor(String::NewSymbol("CULLING"), GetGLU_CULLING);
	Glu->SetAccessor(String::NewSymbol("SAMPLING_TOLERANCE"), GetGLU_SAMPLING_TOLERANCE);
	Glu->SetAccessor(String::NewSymbol("DISPLAY_MODE"), GetGLU_DISPLAY_MODE);
	Glu->SetAccessor(String::NewSymbol("PARAMETRIC_TOLERANCE"), GetGLU_PARAMETRIC_TOLERANCE);
	Glu->SetAccessor(String::NewSymbol("SAMPLING_METHOD"), GetGLU_SAMPLING_METHOD);
	
	Glu->SetAccessor(String::NewSymbol("U_STEP"), GetGLU_U_STEP);
	Glu->SetAccessor(String::NewSymbol("V_STEP"), GetGLU_V_STEP);
	
	Glu->SetAccessor(String::NewSymbol("NURBS_MODE"), GetGLU_NURBS_MODE);
	Glu->SetAccessor(String::NewSymbol("NURBS_MODE_EXT"), GetGLU_NURBS_MODE_EXT);
	Glu->SetAccessor(String::NewSymbol("NURBS_TESSELLATOR"), GetGLU_NURBS_TESSELLATOR);
	Glu->SetAccessor(String::NewSymbol("NURBS_TESSELLATOR_EXT"), GetGLU_NURBS_TESSELLATOR_EXT);
	Glu->SetAccessor(String::NewSymbol("NURBS_RENDERER"), GetGLU_NURBS_RENDERER);
	Glu->SetAccessor(String::NewSymbol("NURBS_RENDERER_EXT"), GetGLU_NURBS_RENDERER_EXT);
	
	Glu->SetAccessor(String::NewSymbol("OBJECT_PARAMETRIC_ERROR"), GetGLU_OBJECT_PARAMETRIC_ERROR);
	Glu->SetAccessor(String::NewSymbol("OBJECT_PARAMETRIC_ERROR_EXT"), GetGLU_OBJECT_PARAMETRIC_ERROR_EXT);
	Glu->SetAccessor(String::NewSymbol("OBJECT_PATH_LENGTH"), GetGLU_OBJECT_PATH_LENGTH);
	Glu->SetAccessor(String::NewSymbol("OBJECT_PATH_LENGTH_EXT"), GetGLU_OBJECT_PATH_LENGTH_EXT);
	
	Glu->SetAccessor(String::NewSymbol("PATH_LENGTH"), GetGLU_PATH_LENGTH);
	
	Glu->SetAccessor(String::NewSymbol("PARAMETRIC_ERROR"), GetGLU_PARAMETRIC_ERROR);
	Glu->SetAccessor(String::NewSymbol("DOMAIN_DISTANCE"), GetGLU_DOMAIN_DISTANCE);
	
	Glu->SetAccessor(String::NewSymbol("MAP1_TRIM_2"), GetGLU_MAP1_TRIM_2);
	Glu->SetAccessor(String::NewSymbol("MAP1_TRIM_3"), GetGLU_MAP1_TRIM_3);
	
	Glu->SetAccessor(String::NewSymbol("POINT"), GetGLU_POINT);
	Glu->SetAccessor(String::NewSymbol("LINE"), GetGLU_LINE);
	Glu->SetAccessor(String::NewSymbol("FILL"), GetGLU_FILL);
	Glu->SetAccessor(String::NewSymbol("SILHOUETTE"), GetGLU_SILHOUETTE);
	
	Glu->SetAccessor(String::NewSymbol("SMOOTH"), GetGLU_SMOOTH);
	Glu->SetAccessor(String::NewSymbol("FLAT"), GetGLU_FLAT);
	Glu->SetAccessor(String::NewSymbol("NONE"), GetGLU_NONE);
	
	Glu->SetAccessor(String::NewSymbol("OUTSIDE"), GetGLU_OUTSIDE);
	Glu->SetAccessor(String::NewSymbol("INSIDE"), GetGLU_INSIDE);
	
	Glu->SetAccessor(String::NewSymbol("BEGIN"), GetGLU_BEGIN);
	Glu->SetAccessor(String::NewSymbol("VERTEX"), GetGLU_VERTEX);
	Glu->SetAccessor(String::NewSymbol("END"), GetGLU_END);
	
	Glu->SetAccessor(String::NewSymbol("TESS_BEGIN"), GetGLU_TESS_BEGIN);
	Glu->SetAccessor(String::NewSymbol("TESS_VERTEX"), GetGLU_TESS_VERTEX);
	Glu->SetAccessor(String::NewSymbol("TESS_END"), GetGLU_TESS_END);
	
	Glu->SetAccessor(String::NewSymbol("TESS_ERROR"), GetGLU_TESS_ERROR);
	Glu->SetAccessor(String::NewSymbol("TESS_EDGE_FLAG"), GetGLU_TESS_EDGE_FLAG);
	Glu->SetAccessor(String::NewSymbol("EDGE_FLAG"), GetGLU_EDGE_FLAG);
	Glu->SetAccessor(String::NewSymbol("TESS_COMBINE"), GetGLU_TESS_COMBINE);
	
	Glu->SetAccessor(String::NewSymbol("TESS_BEGIN_DATA"), GetGLU_TESS_BEGIN_DATA);
	Glu->SetAccessor(String::NewSymbol("TESS_VERTEX_DATA"), GetGLU_TESS_VERTEX_DATA);
	Glu->SetAccessor(String::NewSymbol("TESS_END_DATA"), GetGLU_TESS_END_DATA);
	Glu->SetAccessor(String::NewSymbol("TESS_ERROR_DATA"), GetGLU_TESS_ERROR_DATA);
	Glu->SetAccessor(String::NewSymbol("TESS_EDGE_FLAG_DATA"), GetGLU_TESS_EDGE_FLAG_DATA);
	Glu->SetAccessor(String::NewSymbol("TESS_COMBINE_DATA"), GetGLU_TESS_COMBINE_DATA);
	
	Glu->SetAccessor(String::NewSymbol("CW"), GetGLU_CW);
	Glu->SetAccessor(String::NewSymbol("CCW"), GetGLU_CCW);
	
	Glu->SetAccessor(String::NewSymbol("INTERIOR"), GetGLU_INTERIOR);
	Glu->SetAccessor(String::NewSymbol("EXTERIOR"), GetGLU_EXTERIOR);
	Glu->SetAccessor(String::NewSymbol("UNKNOWN"), GetGLU_UNKNOWN);
	
	Glu->SetAccessor(String::NewSymbol("TESS_WINDING_RULE"), GetGLU_TESS_WINDING_RULE);
	Glu->SetAccessor(String::NewSymbol("TESS_BOUNDARY_ONLY"), GetGLU_TESS_BOUNDARY_ONLY);
	Glu->SetAccessor(String::NewSymbol("TESS_TOLERANCE"), GetGLU_TESS_TOLERANCE);
	
	Glu->SetAccessor(String::NewSymbol("TESS_ERROR1"), GetGLU_TESS_ERROR1);
	Glu->SetAccessor(String::NewSymbol("TESS_ERROR2"), GetGLU_TESS_ERROR2);
	Glu->SetAccessor(String::NewSymbol("TESS_ERROR3"), GetGLU_TESS_ERROR3);
	Glu->SetAccessor(String::NewSymbol("TESS_ERROR4"), GetGLU_TESS_ERROR4);
	Glu->SetAccessor(String::NewSymbol("TESS_ERROR5"), GetGLU_TESS_ERROR5);
	Glu->SetAccessor(String::NewSymbol("TESS_ERROR6"), GetGLU_TESS_ERROR6);
	Glu->SetAccessor(String::NewSymbol("TESS_ERROR7"), GetGLU_TESS_ERROR7);
	Glu->SetAccessor(String::NewSymbol("TESS_ERROR8"), GetGLU_TESS_ERROR8);
	
	Glu->SetAccessor(String::NewSymbol("TESS_MISSING_BEGIN_POLYGON"), GetGLU_TESS_MISSING_BEGIN_POLYGON);
	Glu->SetAccessor(String::NewSymbol("TESS_MISSING_BEGIN_CONTOUR"), GetGLU_TESS_MISSING_BEGIN_CONTOUR);
	Glu->SetAccessor(String::NewSymbol("TESS_MISSING_END_POLYGON"), GetGLU_TESS_MISSING_END_POLYGON);
	Glu->SetAccessor(String::NewSymbol("TESS_MISSING_END_CONTOUR"), GetGLU_TESS_MISSING_END_CONTOUR);
	
	Glu->SetAccessor(String::NewSymbol("TESS_COORD_TOO_LARGE"), GetGLU_TESS_COORD_TOO_LARGE);
	Glu->SetAccessor(String::NewSymbol("TESS_NEED_COMBINE_CALLBACK"), GetGLU_TESS_NEED_COMBINE_CALLBACK);
	
	Glu->SetAccessor(String::NewSymbol("TESS_WINDING_ODD"), GetGLU_TESS_WINDING_ODD);
	Glu->SetAccessor(String::NewSymbol("TESS_WINDING_NONZERO"), GetGLU_TESS_WINDING_NONZERO);
	Glu->SetAccessor(String::NewSymbol("TESS_WINDING_POSITIVE"), GetGLU_TESS_WINDING_POSITIVE);
	Glu->SetAccessor(String::NewSymbol("TESS_WINDING_NEGATIVE"), GetGLU_TESS_WINDING_NEGATIVE);
